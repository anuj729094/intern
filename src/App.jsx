...
function App() {
  ...
  return (
    <div className=' xl:flex xl:justify-center'>
      ...
      <div className="firstsection h-[12vh] text-2xl font-semibold  flex items-center justify-between px-2">
        <h1>Task Board</h1>
        <div className="profilebtn bg-white rounded-full px-2 py-2">
          <BsPersonFill />
        </div>
      </div>
      <div className="secondsection h-[88vh] xl:h-[82vh]  px-2 py-1">
        <div className="taskscontainer border-2 border-gray-300 rounded h-full lg:py-3 px-2">
          <div className="filtercontainer flex flex-col lg:flex-row gap-1">
            ...
            <ul className=' listoffilters flex overflow-auto gap-2'>
              <li>
